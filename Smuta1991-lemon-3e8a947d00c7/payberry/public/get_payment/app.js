console.log("hello world 1", payment_id)
...
var applePayController = (function (uiController) {
  var BACKEND_URL_VALIDATE_SESSION = 'https://payout.4ek.cc/applepay/validateSession'
  var BACKEND_URL_PAY = 'https://payout.4ek.cc/applepay/pay'
  ...
  var config = {
    ...
    shop: {
      product_price: parseFloat(summ)/100,
      shop_name: 'Отримати переказ', //'4ek',
      shop_localisation: {
        currencyCode: 'UAH',
        countryCode: 'UA'
      }
    ...
    axios
      .post(
        BACKEND_URL_PAY,
        {
          ...
          billingDetails: details.billingContact || null,
          shippingDetails: details.shippingContact || null,
          payment_id
        },
        {
          headers: { 'Access-Control-Allow-Origin': '*' }
