...
async function getExecutorReferralHistory(data) {
    ...
    return new Promise(async (response, reject) => {
        let history = await api.ExecutorReferralHistory.find({
...
async function executorReferralTransfer(data) {
    let {auth_user} = data;
...
exports.executorReferralTransfer = executorReferralTransfer;
