define({ "api": [
  ...
  {
    "type": "post",
    "url": "/mobile_api/v1/customer/refill",
    "title": "Получить форму для пополнения счета",
    "name": "customerGetRefillForm",
    "group": "CustomerMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/mobile_api/v2/customer/new_card",
    "title": "Получить форму для добавления новой карты",
    "name": "newCustomerCardForm",
    "group": "CustomerMain",
    "version": "1.0.0",
    "header": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "hourly_rate_minimal_hours",
            "description": "<p>Минимальное количество часов работы по почасовому тарифу (1-8)</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Responfinancial_operationse:",
          "content": "    HTTP/1.1 200 OK\n {\n    \"status\": \"OK\",\n    \"error\": null,\n    \"data\": {}\n}",
          "type": "json"
        }
      ]
  ...
  {
    "type": "delete",
    "url": "/mobile_api/v2/executor/wallet/:id",
    "title": "Редактировать кошелек",
    "name": "addWalletExecutor",
    "group": "ExecutorMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/mobile_api/v2/executor/wallet",
  ...
  {
    "type": "delete",
    "url": "/mobile_api/v1/executor/cards/:id",
    "title": "Удалить мою карту",
    "name": "deleteMyCardExecutor",
    "group": "ExecutorMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/mobile_api/v1/executor/refill",
    "title": "Получить форму для пополнения счета",
    "name": "executorGetRefillForm",
    "group": "ExecutorMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/mobile_api/v1/executor/cards",
    "title": "Получить мои банковские карты",
    "name": "getMyCardsExecutor",
    "group": "ExecutorMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  },
  {
    "type": "get",
    "url": "/mobile_api/v2/executor/wallet",
    "title": "Получить моw кошелек",
    "name": "getWalletExecutor",
    "group": "ExecutorMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/mobile_api/v2/executor/new_card",
    "title": "Получить форму для добавления новой карты",
    "name": "newExecutorCardForm",
    "group": "ExecutorMain",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "   HTTP/1.1 200 OK\n{status:\"OK\", error:\"\", data:{status:1}, alerts['CASH_BALANCE_TOO_LOW', 'NO_ACTIVE_CARD']}",
          "type": "json"
        }
      ]
    },
