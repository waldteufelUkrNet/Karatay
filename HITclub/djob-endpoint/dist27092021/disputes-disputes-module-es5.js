...
var DisputesInfoComponent = /** @class */ (function () {
    function DisputesInfoComponent(route, router, orderService, disputesService, notif) {
        this.route = route;
        this.router = router;
    ...
    DisputesInfoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    DisputesInfoComponent.prototype.getOrderStatus = function (order) {
        return this.orderService.getOrderStatus(order);
    };
    DisputesInfoComponent.ctorParameters = function () { return [
...
var DisputesListComponent = /** @class */ (function () {
    function DisputesListComponent(disputesService, modalService, orderService) {
        this.disputesService = disputesService;
    ...
    DisputesListComponent.prototype.ngOnInit = function () {
        this.refreshDisputes();
    };
    DisputesListComponent.prototype.refreshDisputes = function (reinit) {
        var _this = this;
        ...
        this.disputesService.getlist(options)
            .then(function (list) {
            if (reinit) {
                _this.countDisputes = 0;
                _this.disputesService.getCount(options)
                    .then(function (countData) {
                    _this.countDisputes = countData;
                });
            }
            _this.list = list;
        });
    };
    DisputesListComponent.prototype.searchPhoneRefresh = function () {
        var _this = this;
        clearTimeout(this.timeoutSearch);
        this.timeoutSearch = setTimeout(function () {
            _this.refreshDisputes();
        }, 1000);
    };
    DisputesListComponent.prototype.changeDateFrom = function (val) {
        this.filters.date_from = val;
        this.refreshDisputes();
    };
    DisputesListComponent.prototype.changeDateTo = function (val) {
        this.filters.date_to = val;
        this.refreshDisputes();
    };
    DisputesListComponent.prototype.isEmpty = function (arg) {
        for (var item in arg) {
            return false;
        }
        return true;
    };
    DisputesListComponent.prototype.changeType = function (val) {
    ...
    DisputesListComponent.prototype.pageChanged = function (event) {
        this.range.start = (event - 1) * this.countShowInPage;
        this.refreshDisputes(false);
    };
    DisputesListComponent.ctorParameters = function () { return [
        { type: _shared__WEBPACK_IMPORTED_MODULE_2__["DisputesService"] },
...
var DisputesRoutingModule = /** @class */ (function () {
    function DisputesRoutingModule() {
    }
...
var DisputesComponent = /** @class */ (function () {
    function DisputesComponent() {
    }
    DisputesComponent.prototype.ngOnInit = function () {
    };
...
var DisputesModule = /** @class */ (function () {
...
//# sourceMappingURL=disputes-disputes-module-es5.js.map