...
module.exports = ".action-icon {\n  cursor: pointer;\n  margin: 10px;\n}\n\n.switch-btn {\n  margin-right: 10px;\n}\n\n.controls i {\n  margin: 0 5px;\n  cursor: pointer;\n}\n\n.controls i:before {\n  font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SpecialtiesGroupsComponent = /** @class */ (function () {
    function SpecialtiesGroupsComponent(specialitesService, modalService, notif) {
    ...
    SpecialtiesGroupsComponent.prototype.ngOnInit = function () {
        this.refreshSpecialitesGroup();
    };
    SpecialtiesGroupsComponent.prototype.onScrollEvent = function ($event) {
        var _this = this;
        if (document.body.scrollHeight - window.innerHeight - jquery__WEBPACK_IMPORTED_MODULE_4___default()(window).scrollTop() < 50) {
            ...
            this.timeoutLoad = setTimeout(function () {
                _this.scrollEventActive = false;
                _this.range.start += _this.countShowInPage;
                _this.refreshSpecialitesGroup(false);
            }, 1000);
        }
    };
    SpecialtiesGroupsComponent.prototype.refreshSpecialitesGroup = function (reinit) {
        var _this = this;
        ...
        this.specialitesService.getGrouplist(options)
            ...
            if (list.length) {
                _this.scrollEventActive = true;
            }
        });
    };
    SpecialtiesGroupsComponent.prototype.searchRefresh = function () {
        var _this = this;
        clearTimeout(this.timeoutSearch);
        this.timeoutSearch = setTimeout(function () {
            _this.refreshSpecialitesGroup();
        }, 1000);
    };
    SpecialtiesGroupsComponent.prototype.isEmpty = function (arg) {
        for (var item in arg) {
            return false;
        }
        return true;
    };
    SpecialtiesGroupsComponent.prototype.openGroupDetails = function (content, group) {
    ...
    SpecialtiesGroupsComponent.prototype.saveGroup = function () {
        var _this = this;
        var sendAccess = true;
        ...
        if (sendAccess) {
            if (this.selectedGroup.id) {
                this.specialitesService.updateGroup(this.selectedGroup.id, { name: this.selectedGroup.name })
                    ...
                    _this.refreshSpecialitesGroup(true);
    ...
    SpecialtiesGroupsComponent.prototype.deleteConfirm = function (content, group) {
        this.deleteGroup = group;
        this.modalService.open(content);
    };
    SpecialtiesGroupsComponent.prototype.deleteGroupConfirm = function () {
        var _this = this;
    ...
    SpecialtiesGroupsComponent.ctorParameters = function () { return [
    ...
    return SpecialtiesGroupsComponent;
}());
...
module.exports = ".action-icon {\n  cursor: pointer;\n  margin: 10px;\n}\n\n.switch-btn {\n  margin-right: 10px;\n}\n\n.controls i {\n  margin: 0 5px;\n  cursor: pointer;\n}\n\n.controls i:before {\n  font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SpecialtiesListComponent = /** @class */ (function () {
    function SpecialtiesListComponent(specialitesService, modalService, notif) {
        this.specialitesService = specialitesService;
        this.modalService = modalService;
        this.notif = notif;
        this.countShowInPage = 20;
    ...
    SpecialtiesListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.specialitesService.getGrouplist({})
            .then(function (list) {
            _this.groupsList = list;
        });
        this.refreshSpecialites();
    };
    SpecialtiesListComponent.prototype.refreshSpecialites = function (reinit) {
        var _this = this;
        if (reinit === void 0) { reinit = true; }
        if (reinit) {
            this.range.start = 0;
        ...
        this.specialitesService.getlist(options)
            .then(function (list) {
            if (reinit) {
                _this.countSpecialites = 0;
                _this.specialitesService.getCount(options)
                    .then(function (countData) {
                    _this.countSpecialites = countData;
                });
            }
            _this.list = list;
        });
    };
    SpecialtiesListComponent.prototype.searchRefresh = function () {
        var _this = this;
        clearTimeout(this.timeoutSearch);
        this.timeoutSearch = setTimeout(function () {
            _this.refreshSpecialites();
        }, 1000);
    };
    SpecialtiesListComponent.prototype.isEmpty = function (arg) {
        for (var item in arg) {
            return false;
        }
        return true;
    };
    SpecialtiesListComponent.prototype.openSpecialiteDetails = function (content, specialite) {
        if (specialite === void 0) { specialite = null; }
        if (!specialite) {
    ...
    SpecialtiesListComponent.prototype.saveSpecialite = function () {
        var _this = this;
        var sendAccess = true;
    ...
    SpecialtiesListComponent.prototype.deleteConfirm = function (content, specialite) {
        this.deleteSpecialite = specialite;
        this.modalService.open(content);
    };
    SpecialtiesListComponent.prototype.deleteSpecialiteConfirm = function () {
        var _this = this;
    ...
    SpecialtiesListComponent.prototype.pageChanged = function (event) {
        this.range.start = (event - 1) * this.countShowInPage;
        this.refreshSpecialites(false);
    };
    SpecialtiesListComponent.ctorParameters = function () { return [
        { type: _shared__WEBPACK_IMPORTED_MODULE_2__["SpecialitesService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
        { type: _shared__WEBPACK_IMPORTED_MODULE_2__["NotificationService"] }
    ]; };
    ...
    return SpecialtiesListComponent;
}());
...
//# sourceMappingURL=specialties-specialties-module-es5.js.map